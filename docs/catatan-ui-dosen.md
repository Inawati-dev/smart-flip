...
- Modul dosen: Tambah topik (dengan unggah PDF opsional); aksi per kartu kisi 2×2 selebar sampul (Ganti/Unggah PDF, Ubah topik, Pratinjau, Hapus), tanpa chip status; sampul tidak mencetak nama berkas. Pemilih mata kuliah dan tombol Kelola mata kuliah di kiri sejajar judul (Modul, Video). Nama berkas unggahan baru `topik-<id>-<waktu>`. (#35, #43, papan #72 sampai #74)
